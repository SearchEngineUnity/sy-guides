  ...
  return (
    <Layout>
      ...
      <Container>
        ...
        <p>
          Thank you for taking time to discover Sunny Guides and sending us a message! We’ll be in
          touch soon.
        </p>
        <Row>
        ...
        <p style={{ fontWeight: 'bold' }}>
          Interested in learning more Internet tips and tricks, or discovering awesome new sites and
          apps?
        </p>
        <p>
